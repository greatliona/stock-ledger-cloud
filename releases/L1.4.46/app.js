...
function drawPieLeaderLine(context, label, centerX, centerY, radius, markerX, markerY, side, compact) {
  ...
  if (compact) {
    const laneX = label.anchorX + direction * 6;
    context.lineTo(laneX, label.anchorY);
    context.lineTo(laneX, markerY);
  } else if (Math.abs(label.anchorY - markerY) > 0.5) {
    const laneX = label.anchorX + direction * 10;
    context.lineTo(laneX, label.anchorY);
    context.lineTo(laneX, markerY);
  }
...
function drawMobileOutsidePieLabels(context, labels, centerX, centerY, radius, height, width) {
  ...
  for (const side of ["left", "right"]) {
    ...
    for (const label of sideLabels) {
      ...
      drawPieLeaderLine(context, label, centerX, centerY, radius, markerX, markerY, side, true);
...
function drawOutsidePieLabels(context, labels, centerX, radius, height) {
  ...
  for (const side of ["left", "right"]) {
    ...
    for (const label of sideLabels) {
      ...
      label.y = markerY;
      drawPieLeaderLine(context, label, centerX, centerY, radius, markerX, markerY, side, false);
