...
function drawPieLeaderLine(context, label, centerX, centerY, radius, markerX, markerY, side, compact) {
  ...
  const tangentX = centerX + direction * (radius + (compact ? 6 : 10));
  const guideX = markerX - direction * (compact ? 7 : 18);
  ...
  context.lineTo(tangentX, label.anchorY);
  context.lineTo(guideX, markerY);
